  ...
  return (
    <div className="indicator ">
      ...
      <div className='flex flex-col justify-center w-20 text-center group gap-y-1 place-items-center' onClick={() => setSelected(!selected)}>
        ...
        <p className="invisible mt-4 text-xs font-light text-center bg-white shadow-2xl select-none -z-10 group-hover:animate-duration-500 group-hover:animate-fade group-hover:visible">
          {nodeName}
        </p>
      </div >
    </div >
