    ...
    <tr className='text-xs font-normal truncate animate-pulse'>
      <th >
        <div className='flex gap-x-2 place-items-center'>
          ...
          <div className='flex flex-col justify-start text-xs font-medium gap-y-2'>
            <p>
  ...
  return (
    <div className="flex justify-between w-full h-screen bg-white shadow-2xl rounded-3xl">
      <div className="flex flex-col w-full h-full place-items-center">
        <div
          className={` bg-white h-screen  normal-case border-b-[1px] flex-col  place-items-center animated-flip-down w-full justify-center rounded-t-lg text-xl font-semibold gap-x-2   `}
        >
