...
const fetchingArticleSkeleton = (
            <div className="absolute top-0 flex-col w-full p-2 my-2 animate-pulse rounded-3xl gap-y-2">
              {[...Array(6)].map(() => (
              <div className="flex flex-col justify-start w-full animate-fade-left animate-pulse">
