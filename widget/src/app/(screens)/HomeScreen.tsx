    ...
    <>
      ...
      >
        ...
        <div className=" backdrop-blur-3xl bg-white/10 hover:bg-white/5  shadow-xl border-[1px] h-20    rounded-3xl mx-4 gap-y-4 animate-fade-left animate-once">
          ...
          {articles.isLoading || (articles.isFetched && articles?.data?.length) && <div className=" dark:bg-gray-900 bg-white border-gray-300  shadow-md border-[1px] text-normal    rounded-3xl mx-4 gap-y-4 animate-fade-left">
