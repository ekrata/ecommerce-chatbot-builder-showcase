...
//   'GET /orgs/{orgId}/operators/{operatorId}/getSignedProfileUpload':
//     '@/packages/functions/app/api/src/operators/getSignedProfileUpload.handler',
