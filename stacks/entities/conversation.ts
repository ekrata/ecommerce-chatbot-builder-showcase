...
export const conversationChannel = ["live", "chatbot", "facebook", "whatsapp", "instagram"] as const;
...
export const conversationTopic = ['products', 'order_status', 'order_issues', 'shipping_policy'] as const
